...
import static ru.prusov.TelegramBotConstructionHelper.usecase.state.UserState.WAITING_UPDATE_CONTRACT_END;

@Component
@Slf4j
@RequiredArgsConstructor
public class UpdateContractEndDateState extends AbstractState {

    private String CONTENT_TEXT = """
            Изменена дата окончания работ. 
    ...
    protected void doExecute(CommonInfo commonInfo) {
        ...
        contractDTOFull.setEndDate(startDate);
    ...
    public UserState state() {
        return WAITING_UPDATE_CONTRACT_END;
    }
}
