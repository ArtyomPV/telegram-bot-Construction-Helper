...
import static ru.prusov.TelegramBotConstructionHelper.usecase.state.UserState.WAITING_UPDATE_CONTRACT_DESCRIPTION;

@Component
@Slf4j
@RequiredArgsConstructor
public class UpdateContractDescriptionState extends AbstractState {
    private String CONTENT_TEXT = """
            Изменено описание договора
    ...
    protected void doExecute(CommonInfo commonInfo) {
        ...
        contractDTOFull.setDescription(messageText);
    ...
    public UserState state() {
        return WAITING_UPDATE_CONTRACT_DESCRIPTION;
    }
}
