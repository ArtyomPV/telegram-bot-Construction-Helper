...
public class ContractRemoveCallbackCommand extends AbstractCallbackCommand {
    ...
    protected void doExecute(CommonInfo commonInfo) {
        ...
        stateService.setUserStateByChatId(chatId, UserState.CONTRACT_REMOVE);
